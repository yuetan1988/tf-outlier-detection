...
class KerasTrainer(object):
    ...
    def train(
        ...
        **kwargs
        ...
        self.model.compile(loss=self.loss_fn, optimizer=self.optimizer, metrics=callback_eval_metrics)
    ...
    def save_model(self, model_dir, only_pb=True, checkpoint_dir=None):
        ...
        self.model.save_weights("{}".format(model_dir))
        print("model weights successfully saved in {}".format(model_dir))
        return
